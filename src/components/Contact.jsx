...
const Contact = () => {
  ...
  return (
    <section id="contact" style={{ padding: '160px 5%' }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '80px' }}>
          ...
          <p style={{ color: '#888', fontSize: '1.2rem', maxWidth: '600px', margin: '0 auto' }}>
            PathAI helps SaaS founders and service businesses ship AI-powered web products in under 14 days. Start your protocol below.
          </p>
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '60px', flexWrap: 'wrap' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#666' }}>
            <Mail size={18} />
            <span style={{ fontSize: '0.9rem' }}>hello@pathai.name.ng</span>
          </div>
