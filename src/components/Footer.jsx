    ...
    <footer style={{ padding: '80px 5% 40px', background: '#050505', borderTop: '1px solid #111', textAlign: 'center' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', marginBottom: '40px' }}>
          <img src="/favicon.svg" alt="Michael Adewale" style={{ width: '30px', height: '30px', borderRadius: '6px' }} />
        ...
        <div className="footer-links" style={{ marginBottom: '40px' }}>
          <Link to="/collab/brief" style={{ color: 'var(--accent-color)', fontWeight: '600' }}>Gig Brief Form</Link>
          <span style={{ color: '#333', margin: '0 10px' }}>|</span>
          <Link to="/collab/guide" style={{ color: '#666', textDecoration: 'none' }}>Collab Guide</Link>
        </div>

        <div className="social-links">
          <a href="https://linkedin.com/in/michael-adewale-140806243" target="_blank" rel="noreferrer"><Linkedin size={20} /></a>
